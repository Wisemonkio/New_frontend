          ...
          <form onSubmit={handleSubmit} className="content-stretch flex flex-col gap-2 sm:gap-2.5 items-start relative shrink-0 w-full min-w-full">
            ...
            <div className="content-stretch flex flex-col gap-1.5 items-start relative shrink-0 w-full min-w-full">
              ...
              <div className="content-stretch flex flex-col gap-1 items-start relative shrink-0 w-full">
                <div className={`bg-white border border-solid content-stretch flex flex-col items-start overflow-clip px-2.5 sm:px-3 py-1.5 sm:py-2 relative rounded-lg shrink-0 w-full transition-colors ${
              ...
              <div className="w-full text-right mt-0.5">
                <button
                  ...
                  className="text-xs text-primary-base hover:text-primary-base/80 font-satoshi font-medium transition-colors"
                >
                  Forgot password?
                </button>
              </div>
